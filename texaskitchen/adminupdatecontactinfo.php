...
<html>
<head>
  <title>Texas Kitchen -- Admin Update Contact Information</title>
			...
			<div class="top-nav">
				<div class="top-nav-left">
					<ul>
						...
						<li class="active"><a href="adminaccount.html"> My Account</a></li>
				...
				<div class="section group">
				  ...
				  <div class="contact-form">
				  	<h3>update contact information</h3>
					    <form method="POST" action="go_adminupdatecontactinfo.php" id="userupdatecontactinfo-form">
					    	<div>
                          ...
                          <div>
					       ...
					       <div>
                             ...
                             <a href="admin_order.html"><input type="button" class="mybutton" value="Cancel"></a></span>
						  </div>
					    </form>
