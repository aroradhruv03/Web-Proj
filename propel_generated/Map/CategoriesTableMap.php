...
class CategoriesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CategoriesTableMap';
     ...
     */
    const OM_CLASS = '\\Categories';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Categories';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('CategoryId', 'CategoryName', ),
        self::TYPE_CAMELNAME     => array('categoryId', 'categoryName', ),
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_CATEGORY_ID, CategoriesTableMap::COL_CATEGORY_NAME, ),
        self::TYPE_FIELDNAME     => array('Category_ID', 'Category_name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('CategoryId' => 0, 'CategoryName' => 1, ),
        self::TYPE_CAMELNAME     => array('categoryId' => 0, 'categoryName' => 1, ),
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_CATEGORY_ID => 0, CategoriesTableMap::COL_CATEGORY_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('Category_ID' => 0, 'Category_name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('Category_name', 'CategoryName', 'VARCHAR', true, 120, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':Category_ID',
        ...
        $this->addRelation('Subcategories', '\\Subcategories', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':Category_ID',
    1 => ':Category_ID',
  ),
), null, null, 'Subcategoriess', false);
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CategoriesTableMap::COL_CATEGORY_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CategoriesTableMap::COL_CATEGORY_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CategoriesTableMap::COL_CATEGORY_ID) && $criteria->keyContainsValue(CategoriesTableMap::COL_CATEGORY_ID) ) {
