...
abstract class User implements ActiveRecordInterface
{
    ...
    /**
     * The value for the phone_no field.
     *
     * @var        int
     */
    protected $phone_no;
    ...
    public function setAddress1($v)
    {
        ...
        if ($this->address1 !== $v) {
            $this->address1 = $v;
            $this->modifiedColumns[UserTableMap::COL_ADDRESS1] = true;
        }
    ...
    /**
     * Set the value of [phone_no] column.
     *
     * @param int $v new value
     * @return $this|\User The current object (for fluent API support)
     */
    public function setPhoneNo($v)
    {
        ...
        if ($this->phone_no !== $v) {
            $this->phone_no = $v;
            $this->modifiedColumns[UserTableMap::COL_PHONE_NO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('Address1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('Address2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UserTableMap::translateFieldName('Zipcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zipcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UserTableMap::translateFieldName('PhoneNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_no = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ADDRESS1)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PHONE_NO)) {
            $modifiedColumns[':p' . $index++]  = 'Phone_no';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Zipcode':
                        ...
                        break;
                    case 'Phone_no':
                        $stmt->bindValue($identifier, $this->phone_no, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ADDRESS1)) {
            $criteria->add(UserTableMap::COL_ADDRESS1, $this->address1);
        }
        if ($this->isColumnModified(UserTableMap::COL_ADDRESS2)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PHONE_NO)) {
            $criteria->add(UserTableMap::COL_PHONE_NO, $this->phone_no);
        }
